const coursesData = [
  {
    ...
    title: "Core Java",
    description:
      "Master Java fundamentals and build strong programming skills with real-world applications.",
  ...
  },
  {
    ...
    description:
      "Learn JavaScript from basics to advanced and build dynamic web applications with ease.",
    icon: "/js-icon.png",
  },
  {
    id: 3,
    title: "Next.js & React",
    description:
      "Develop high-performance web applications using Next.js and React with best practices.",
  ...
  },
  {
    ...
    description:
      "Explore data science concepts using Python, Pandas, NumPy, and machine learning libraries.",
  ...
  },
  {
    ...
    description:
      "Learn full-stack web development with hands-on projects covering HTML, CSS and More.",
